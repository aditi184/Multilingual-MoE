# python convert_olmo_hf.py --input_dir /home/mila/k/khandela/scratch/ai2-llm/runs/pretrain-multilingual-en-hi-ar-ru-zh-nolbl/step1900-unsharded --output_dir /home/mila/k/khandela/scratch/ai2-llm/checkpoints/OLMoE/multilingual-5langs-nolbl-1900 --tokenizer_json_path /scratch/ai2-llm/runs/pretrain-multilingual-en-hi-ar-ru-zh/step1200-unsharded/tokenizer.json --no_fix_eos_token_id
import argparse
import gc
import json
import os
